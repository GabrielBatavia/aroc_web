  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[9/16] w-full overflow-hidden">
        ...
        <div className="absolute left-5 top-5 rounded-full bg-[var(--yellow)] px-4 py-2 font-mono text-[0.64rem] font-black uppercase tracking-[0.18em] text-[var(--navy-deep)] shadow-md">
          Unit {robot.unitNumber || String(index + 1).padStart(2, "0")}
        </div>
      </div>
      ...
      <div className="relative z-10 p-6 sm:p-7">
        ...
        <p className="mt-4 text-[0.96rem] leading-[1.75] text-[rgba(248,247,240,0.7)]">
          {robot.description}
        </p>

        {robot.uniqueFact && (
          <div className="mt-5 rounded-xl border border-[rgba(255,228,92,0.15)] bg-[rgba(255,228,92,0.04)] p-4">
            <div className="font-mono text-[0.62rem] font-black uppercase tracking-[0.16em] text-[var(--yellow)] mb-1">
              Fakta Unik
            </div>
            <p className="text-[0.88rem] leading-[1.6] text-[rgba(248,247,240,0.8)]">
              {robot.uniqueFact}
            </p>
          </div>
        )}
        ...
        {robot.teamTask && (
          <div className="mt-3 rounded-xl border border-[rgba(248,247,240,0.1)] bg-[rgba(248,247,240,0.03)] p-4">
            <div className="font-mono text-[0.62rem] font-black uppercase tracking-[0.16em] text-[rgba(248,247,240,0.6)] mb-1">
              Tugas Dalam Tim
            </div>
            <p className="text-[0.88rem] leading-[1.6] text-[rgba(248,247,240,0.8)]">
              {robot.teamTask}
