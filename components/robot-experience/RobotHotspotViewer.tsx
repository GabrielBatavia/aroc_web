...
export function RobotHotspotViewer({
  ...
  return (
    <section className="relative overflow-hidden rounded-[2.6rem] border border-[rgba(255,228,92,0.22)] bg-[linear-gradient(140deg,rgba(10,18,42,0.96),rgba(3,6,16,0.98)_52%,rgba(24,35,76,0.9))] shadow-[0_48px_120px_-76px_rgba(0,0,0,1)]">
      ...
      <div className="relative z-10 grid min-h-[720px] gap-0 lg:grid-cols-[1fr_23rem]">
        <div className="relative min-h-[680px] overflow-hidden px-3 pt-8 sm:px-8 lg:min-h-[760px]">
          <div className="absolute left-5 top-5 z-30 flex flex-wrap gap-2 sm:left-8 sm:top-8">
          ...
          {viewerReady && !hasError ? (
            <model-viewer
              ...
              touch-action="pan-y"
              {...(autoRotate ? { "auto-rotate": true, "auto-rotate-delay": "2400" } : {})}
            >
          ...
          {hasError ? (
            <div className="absolute bottom-8 left-1/2 z-30 -translate-x-1/2 rounded-full border border-[rgba(248,247,240,0.18)] bg-[rgba(5,8,22,0.78)] px-5 py-2.5 font-mono text-[0.62rem] font-black uppercase tracking-[0.18em] text-[rgba(248,247,240,0.72)] backdrop-blur">
              Fallback 2D aktif
            </div>
          ) : null}
        </div>
        ...
        <aside className="relative z-20 border-t border-[rgba(255,228,92,0.16)] bg-[rgba(3,6,16,0.52)] p-5 backdrop-blur-2xl sm:p-7 lg:border-l lg:border-t-0">
          <div className="sticky top-28">
            ...
            <div className="mt-6 rounded-[1.4rem] border border-[rgba(255,228,92,0.18)] bg-[rgba(255,228,92,0.07)] p-4">
              <div className="font-mono text-[0.58rem] font-black uppercase tracking-[0.18em] text-[var(--yellow)]">
                Why it matters
              </div>
              <p className="mt-3 text-[0.9rem] leading-[1.72] text-[rgba(248,247,240,0.7)]">
              ...
              {hotspots.map((hotspot) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center justify-between gap-4 rounded-2xl border px-4 py-3 text-left transition duration-200 ${
                      isActive
                        ? "border-[var(--yellow)] bg-[var(--yellow)] text-[var(--navy-deep)]"
